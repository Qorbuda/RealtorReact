    ...
    return (
        <div>
            {modalOpen && <div className="image-modal-container">
                <div> 
                    <img className="modal-image" src={`https://167.86.75.34/api/image/${imagesArray[currentSlide]}`} />
            ...
            <div className="image-container">
                <img className="main-picture" src={`https://167.86.75.34/api/image/${mainImage}`} />
                <div className="small-picture-container">
                    {smallImages.map((image, index) => (
                        <img className="small-picture" src={`https://167.86.75.34/api/image/${image}`} key={index} />
                    ))}
                </div>
